    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12"><br />
                <h1 align="center"><kbd>แก้ไขข้อมูลผู้ใช้</kbd></h1><br />
            @if(count($errors)>0)
                ...
                <form method="post" action="{{action('MembersController@update',$id)}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="fname" class="form-control" placeholder="ป้อนชื่อ" value ="{{$member->fname}}"/>
                    </div>
                    
                    <div class="form-group">
                        <label for="name">นามสกุล</label>
                        <input type="text" name="lname" class="form-control" placeholder="ป้อนนามสกุล" value ="{{$member->lname}}"/>
                    </div>
                    <div class="form-group"> 
                        <label for="name">เบอร์โทร</label>
                        <input type="text" name="tel" class="form-control" placeholder="ป้อนเบอร์โทร" value ="{{$member->tel}}"/>
                    </div>
                    <div class="form-group">
                        <label for="name">อีเมลล์</label>
                        <input type="text" name="email" class="form-control" placeholder="ป้อนอีเมลล์" value ="{{$member->email}}"/>
                    </div>
                    <div class="form-group">
                        <label for="name">ที่อยู่</label>
                        <input type="text" name="address" class="form-control" placeholder="ป้อนที่อยู่" value ="{{$member->address}}"/>
                    </div> 
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="code" class="code form-control" placeholder="ป้อนรหัสไปรษณีย์" value="{{$member->code}}"/>
                    </div> 
                    ...
                    <div class="row">
                        ...
                        <a href = {{route('member.index')}} class="btn btn-danger">กลับ</a> 
                    </div>
                </div>
                <br><br>
                </form>
